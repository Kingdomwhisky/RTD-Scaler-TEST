...
#if(_PROJECT == _RL6432_BEACON_PROJECT)
...
// Pcb Option
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6432_BEACON_B_76PIN_1A1H_eDP//_RL6432_DEMO_C_D_216PIN_1A2MHL1DP1mDP_DPTX_LVDS_eDP

//--------------------------------------------------
// Panel Option
//--------------------------------------------------
#define _PANEL_TYPE                                             _LG_LP156WF6_SPB1_eDP_FHD//_AU_LVDS_21_5_WUXGA
#define _PANEL_POW_SEQ_FAST_MODE                                _ON

//--------------------------------------------------
// Osd Option
//--------------------------------------------------
#define _OSD_TYPE                                               _BEACON_OSD

#define _OSD_INCLUDE                                            "BeaconInclude.h"
#define _USER_FUNCTION_INCLUDE                                  "BeaconUserInclude.h"
#define _USER_TIMER_INCLUDE                                     "BeaconTimerInclude.h"
#define _FACTORY_INCLUDE                                        "BeaconFactoryInclude.h"
#define _USER_HWIIC_INCLUDE                                     "BeaconHWIICInclude.h"
...
#define _DDCCI_TXBUF_LENGTH                                     128//16
...
#define _ULTRA_VIVID_SUPPORT                                    _OFF//_ON
...
#define _HIGHLIGHT_WINDOW_SUPPORT                               _OFF//_ON
...
//-------------------------------------------------
#define _SYSTEM_EEPROM_EMULATION_SUPPORT                        _ON//_OFF

#define _SYSTEM_EEPROM_EMULATION_FLASH_BANK                     7//11
...
#else
#define _EDID_ADDRESS_EEPROM                                    (_MISC_PAGE * _FLASH_PAGE_SIZE)
#endif

#define _EDID_ADDRESS_FLASH                                     (_MISC_PAGE * _FLASH_PAGE_SIZE)
#define _EDID_FLASH_BANK                                        _SYSTEM_EEPROM_EMULATION_FLASH_BANK
...
// Audio Option
//-------------------------------------------------
#define _AUDIO_SUPPORT                                          _OFF//_ON
...
#endif // End of #if(_PROJECT == _RL6432_BEACON_PROJECT)
