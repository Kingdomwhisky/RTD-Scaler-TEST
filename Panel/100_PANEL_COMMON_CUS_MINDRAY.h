...
#if(_PANEL_TYPE == _PANEL_COMMON_CUS_MINDRAY)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#if((_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_VIETE_VL097IA13) || \
    (_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_G097XL_S03))
...
#if(_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_LG_LM215WF3_SLK1)
#undef _PANEL_STR
#define _PANEL_STR                              "LG_LM215WF3_SLK1"

#define _InFlashLvdsDisplayBitMode              _PANEL_DISP_24_BIT
#define _InFlashDitherWitch                     _ENABLE
#define _InFlashPanelMaxFrameRate               860

#define _InFlashPanelDhStart                    32
...
#define _InFlashPanelMaxDhTotal                 2240
#define _InFlashPanelDhTotal                    2176
#define _InFlashPanelMinDhTotal                 2048

#define _InFlashPanelMaxDvTotal                 1251
#define _InFlashPanelDvTotal                    1100
#define _InFlashPanelMinDvTotal                 1090

#define _InFlashPanelMaxPixClock                180
#define _InFlashPanelPixClock                   144
#define _InFlashPanelMinPixClock                120

#define _InFlashPanelPowerOnT1                  30
#define _InFlashPanelPowerOnT2                  10
#define _InFlashPanelPowerOnT3                  520
#define _InFlashPanelPowerOffT4                 400
#define _InFlashPanelPowerOffT5                 16
#define _InFlashPanelPowerOffT6                 1000

#define _PWM_FREQ                               240
#define _PWM_INVERSE                            _ON

#elif(_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_LG_LM215WF3_SLS1)
#undef _PANEL_STR
#define _PANEL_STR                              "LG_LM215WF3_SLS1"
...
#elif(_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_LG_LM238WF1_SLK1)
#undef _PANEL_STR
...
#define _InFlashPanelMaxDvTotal                 1160
#define _InFlashPanelDvTotal                    1100
#define _InFlashPanelMinDvTotal                 1090
...
#define _InFlashPanelPowerOnT1                  10
#define _InFlashPanelPowerOnT2                  30
#define _InFlashPanelPowerOnT3                  550
#define _InFlashPanelPowerOffT4                 250
#define _InFlashPanelPowerOffT5                 20
#define _InFlashPanelPowerOffT6                 1050

#define _PWM_FREQ                               240
#define _PWM_INVERSE                            _ON

#elif(_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_INN_R238HCA_L3B)
#undef _PANEL_STR
#define _PANEL_STR                              "INN_R238HCA_L3B"
...
#define _InFlashPanelMaxDhTotal                 2300
#define _InFlashPanelDhTotal                    2200
#define _InFlashPanelMinDhTotal                 2030

#define _InFlashPanelMaxDvTotal                 1257
#define _InFlashPanelDvTotal                    1125
#define _InFlashPanelMinDvTotal                 1100

#define _InFlashPanelMaxPixClock                196
#define _InFlashPanelPixClock                   149
#define _InFlashPanelMinPixClock                112
...
#elif(_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_VIETE_VL097IA13)
#undef _PANEL_STR
#define _PANEL_STR                              "VIETE_VL097IA13"

#define _InFlashLvdsDisplayBitMode              _PANEL_DISP_18_BIT
#define _InFlashDitherWitch                     _ENABLE
#define _InFlashPanelMaxFrameRate               630
...
#define _InFlashPanelDhWidth                    1024
#define _InFlashPanelDvHeight                   768

#define _InFlashPanelMaxDhTotal                 1600
#define _InFlashPanelDhTotal                    1344
#define _InFlashPanelMinDhTotal                 1140

#define _InFlashPanelMaxDvTotal                 900
#define _InFlashPanelDvTotal                    806
#define _InFlashPanelMinDvTotal                 776

#define _InFlashPanelMaxPixClock                80
#define _InFlashPanelPixClock                   65
#define _InFlashPanelMinPixClock                54

#define _InFlashPanelPowerOnT1                  5
#define _InFlashPanelPowerOnT2                  20
#define _InFlashPanelPowerOnT3                  250
#define _InFlashPanelPowerOffT4                 250
#define _InFlashPanelPowerOffT5                 20
#define _InFlashPanelPowerOffT6                 750

#define _PWM_FREQ                               1800
#define _PWM_INVERSE                            _ON

#elif(_MINDRAY_PANEL_SELECT == _MINDRAY_PANEL_G097XL_S03)
#undef _PANEL_STR
#define _PANEL_STR                              "G097XL_S03"
...
#define _InFlashPanelMaxDhTotal                 1400
#define _InFlashPanelDhTotal                    1344
#define _InFlashPanelMinDhTotal                 1114

#define _InFlashPanelMaxDvTotal                 845
#define _InFlashPanelDvTotal                    806
#define _InFlashPanelMinDvTotal                 778

#define _InFlashPanelMaxPixClock                71
#define _InFlashPanelPixClock                   65
#define _InFlashPanelMinPixClock                52
...
#define _InFlashPanelMaxDhTotal                 2200
#define _InFlashPanelDhTotal                    2100
#define _InFlashPanelMinDhTotal                 2008

#define _InFlashPanelMaxDvTotal                 1793
#define _InFlashPanelDvTotal                    1130
#define _InFlashPanelMinDvTotal                 1092

#define _InFlashPanelMaxPixClock                180
#define _InFlashPanelPixClock                   142
#define _InFlashPanelMinPixClock                107

#define _InFlashPanelPowerOnT1                  30
#define _InFlashPanelPowerOnT2                  10
#define _InFlashPanelPowerOnT3                  550                 //520
#define _InFlashPanelPowerOffT4                 250
#define _InFlashPanelPowerOffT5                 20
#define _InFlashPanelPowerOffT6                 1010
