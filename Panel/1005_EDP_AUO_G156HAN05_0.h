...
#if(_PANEL_TYPE == _EDP_AUO_G156HAN05_0)
//----------------------------------------------------------------------------------------------------
// ID Code      :  No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                              "AUO_G156HAN05_0"
...
#define _PANEL_DV_TOTAL                         1116
#define _PANEL_DV_TOTAL_MAX                     1200
#define _PANEL_DV_TOTAL_MIN                     1112
...
#define _PANEL_PIXEL_CLOCK_MIN                  139
