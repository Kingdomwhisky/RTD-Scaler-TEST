...
#if(_PANEL_TYPE == _INNOLUX_R190ECE_L01)
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                             "INNO_R190ECE_L01"
...
#define _PANEL_DH_TOTAL_MAX                     1780                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1580                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1124                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  150                 // Maxinum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_PWM_TO_BL              250                  // pwm to backlight onoff delay
