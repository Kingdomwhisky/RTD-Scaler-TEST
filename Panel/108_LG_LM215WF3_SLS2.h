...
#if(_PANEL_TYPE == _LG_LM215WF3_SLS2)
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                             "LG_LM215WF3_SLS2"
...
#define _PANEL_DV_TOTAL_MAX                     1965                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_POWER_OFF_T6                     1500                 // Panel Power Off T6 (ms)
