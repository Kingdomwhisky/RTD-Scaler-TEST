...
#if(_PANEL_TYPE == _AUO_G190EAN01_0)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MAX                     4094                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1560                // Mininum Display Horizontal Total Clock Number in One Display Line
