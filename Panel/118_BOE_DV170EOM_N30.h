...
#if(_PANEL_TYPE == _BOE_DV170EOM_N30)
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                             "BOE_DV170EOM_N30"
...
#define _PANEL_DH_TOTAL_MAX                     1880                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MIN                     1037                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  114                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  102                  // Mininum Pixel Clock in MHz
