...
#if(_PANEL_TYPE == _TIANMA_NL10276AC30_48D)
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                             "NL10276AC30_48D"
...
#define _PANEL_DH_END                           (32+1024)           // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         1344                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     1400                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1114                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         6//6                   // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        768                // Display Vertical Width
#define _PANEL_DV_END                           (6+768)                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         806                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     845                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     780                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      65                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  71                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  52                 // Mininum Pixel Clock in MHz
