...
#if(_PANEL_TYPE == _EDP_BOE_EV156FHM_N43)
//----------------------------------------------------------------------------------------------------
// ID Code      :  No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                              "BOE_EV156FHM_N43"
...
#define _PANEL_DV_TOTAL                         1140
#define _PANEL_DV_TOTAL_MAX                     1200
...
#define _PANEL_PIXEL_CLOCK_MAX                  158
#define _PANEL_PIXEL_CLOCK_MIN                  101
