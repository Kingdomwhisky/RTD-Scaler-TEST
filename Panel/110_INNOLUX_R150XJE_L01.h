...
#if(_PANEL_TYPE == _INNOLUX_R150XJE_L01)
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                             "INNO_R150XJE_L01"
...
#define _PANEL_DH_TOTAL_MAX                     1600                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     1140                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     1200                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  80                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  54                 // Mininum Pixel Clock in MHz
