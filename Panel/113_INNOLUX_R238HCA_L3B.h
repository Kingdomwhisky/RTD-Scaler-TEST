...
#if(_PANEL_TYPE == _INNOLUX_R238HCA_L3B)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DV_TOTAL_MAX                     1257                // Maxinum Display Vertical Total Clock Number in One Display Line
