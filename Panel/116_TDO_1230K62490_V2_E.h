...
#if(_PANEL_TYPE == _TDO_1230K62490_V2_E)
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                             "TDO_1230K62490_V2_E"
...
#define _PANEL_DV_TOTAL                         728                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     849                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     680                // Mininum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK_MAX                  101                 // Maxinum Pixel Clock in MHz
