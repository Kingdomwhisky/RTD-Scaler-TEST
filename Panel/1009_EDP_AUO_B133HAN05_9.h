...
#if(_PANEL_TYPE == _EDP_AUO_G133HAN05_9)
//----------------------------------------------------------------------------------------------------
// ID Code      :  No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                              "AUO_G133HAN05_9"
...
#define _PANEL_DH_TOTAL_MAX                     2250
...
#define _PANEL_DV_TOTAL_MAX                     1150
#define _PANEL_DV_TOTAL_MIN                     1120//1142

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      148
#define _PANEL_PIXEL_CLOCK_MAX                  150//149
#define _PANEL_PIXEL_CLOCK_MIN                  143
