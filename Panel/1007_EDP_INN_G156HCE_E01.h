...
#if(_PANEL_TYPE == _EDP_INN_G156HCE_E01)
//----------------------------------------------------------------------------------------------------
// ID Code      :  No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                              "INN_G156HCE_E01"
...
#define _PANEL_DH_TOTAL                         2250
#define _PANEL_DH_TOTAL_MAX                     2260
...
#define _PANEL_DV_TOTAL                         1132
#define _PANEL_DV_TOTAL_MAX                     1136
#define _PANEL_DV_TOTAL_MIN                     1100

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      153
#define _PANEL_PIXEL_CLOCK_MAX                  155
