...
//----Beacon pcb define----------
#define _RL6432_BEACON_B_76PIN_1A1H_eDP                             0x103 // Beacon 2313
#define _RL6432_BEACON_B_156PIN_1A1H2DP_LVDS_eDP                    0x104 // Beacon 2556
#define _RL6432_UNITED_A_216PIN_1A1DP1DUALDVI_DPTX_LVDS_eDP         0x105 // Beacon 2785

//----------------------------------------------------------------------------------------------------
// Beacon Input Port Select List
//----------------------------------------------------------------------------------------------------
#define INPUT_LIST_DEFAULT                                          0
#define INPUT_LIST_ONLY_D1                                          1
#define INPUT_LIST_ONLY_D3                                          2
#define INPUT_LIST_A0_D1                                            3
#define INPUT_LIST_A0_D3                                            4
#define INPUT_LIST_D1_D3                                            5
#define INPUT_LIST_D0_D3                                            6
...
#define _IIC_A0_EEPROM                                              3
#define _IIC_D0_EEPROM                                              4
#define _IIC_D1_EEPROM                                              5
#define _IIC_D3_EEPROM                                              6
#define _IIC_USER_EEPROM                                            7
#define _IIC_USER_SENSOR                                            8
#define _IIC_SYS_BUS_EXTDEV_I2C0                                    9
#define _IIC_SYS_BUS_EXTDEV_I2C1                                    10
...
#define _LVDS_DRIV_CONTROL_USER_MODE_1                              7
#define _LVDS_DRIV_CONTROL_USER_MODE_2                              8
#define _LVDS_DRIV_CONTROL_USER_MODE_3                              9
