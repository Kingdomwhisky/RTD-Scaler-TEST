...
//----------------------------------------------------------------------------------------------------
// ID Code      : BeaconNVRamOsd.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _OTHER_USER_DATA_ADDRESS                       (_PANEL_TIME_DATA_ADDRESS_END)
#define _OTHER_USER_DATA_ADDRESS_END                   (_OTHER_USER_DATA_ADDRESS + sizeof(StructOtherUserDataType))
...
typedef struct
{
    WORD Sensor_brightness_value;
    WORD Sensor_backlight_value;
#if(_CUSTOMER == _CUS_TOSHIBA)
    WORD Sensor_brightness_default[2];
#else
    WORD Sensor_brightness_default;
#endif
    BYTE ucExternEdidStutas;
#if(_NEW_BACKLIGHT_SENSOR_FUN_EN == _ON)
    BYTE ucBacklightSensorOnOff;
#endif
#if(_HDMI_SPLITTER_1X2_EN == _ON)
    BYTE Data1st_OutPutSelect : 2;
    BYTE Data1st_Equalization : 2;
    BYTE Data1st_PortAControl : 4;
    BYTE Data2nd_OutPutSelect : 2;
    BYTE Data2nd_NoUse : 2;
    BYTE Data2nd_PortBControl : 4;
#endif

} StructOtherUserDataType;
...
extern BYTE g_ucContrast;
extern BYTE g_ucBackLight;
extern BYTE g_ucColorTempType;
extern BYTE g_ucGamma;
extern BYTE g_ucNativeColorTemp;
extern BYTE g_ucALS_Manual_Auto;
#endif
...
extern StructOtherUserDataType g_stOtherUserData;

#if(_DDC_DETECT_EN == _ON)
extern BYTE g_ucForceSetDDC;
#endif
...
extern void RTDEepromSaveOtherUserData(void);
extern void RTDEepromRestoreOtherUserData(void);
...
#define RTDNVRamSaveOtherUserData()                    RTDEepromSaveOtherUserData()
#define RTDNVRamRestoreOtherUserData()                 RTDEepromRestoreOtherUserData()
...
extern void RTDFlashSaveOtherUserData(void);
extern void RTDFlashRestoreOtherUserData(void);
...
#define RTDNVRamSaveOtherUserData()                    RTDFlashSaveOtherUserData()
#define RTDNVRamRestoreOtherUserData()                 RTDFlashRestoreOtherUserData()
