...
//----------------------------------------------------------------------------------------------------
// ID Code      : BeaconUserInterDimming.c
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#if((_OSD_TYPE == _BEACON_OSD) && (_BACKLIGHT_DIMMING_SUPPORT == _ON))
...
#endif // End of #if((_OSD_TYPE == _BEACON_OSD) && (_BACKLIGHT_DIMMING_SUPPORT == _ON))
