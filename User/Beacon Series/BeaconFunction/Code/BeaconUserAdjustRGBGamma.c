...
//----------------------------------------------------------------------------------------------------
// ID Code      : BeaconUserAdjustRGBGamma.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#if((_OSD_TYPE == _BEACON_OSD) && (_RGB_GAMMA_FUNCTION == _ON))
...
#endif // End of #if((_OSD_TYPE == _BEACON_OSD) && (_RGB_GAMMA_FUNCTION == _ON))
