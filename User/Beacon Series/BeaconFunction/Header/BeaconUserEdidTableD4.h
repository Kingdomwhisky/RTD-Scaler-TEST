...
// EDID Table
//--------------------------------------------------
#if((_D4_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE) && (_D4_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_FLASH))

#ifdef _InFlashPanelDhWidth
#define D4_PANEL_DH_WIDTH     _InFlashPanelDhWidth
#else
#ifdef _PANEL_DH_WIDTH
#define D4_PANEL_DH_WIDTH     _PANEL_DH_WIDTH
#else
#define D4_PANEL_DH_WIDTH      1920
#endif
#endif

#ifdef _InFlashPanelDvHeight
#define D4_PANEL_DV_HEIGHT     _InFlashPanelDvHeight
#else
#ifdef _PANEL_DV_HEIGHT
#define D4_PANEL_DV_HEIGHT     _PANEL_DV_HEIGHT
#else
#define D4_PANEL_DV_HEIGHT      1080
#endif
#endif
