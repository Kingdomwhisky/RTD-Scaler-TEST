...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_BEACON_B_76PIN_1A1H_eDP_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
// hdmi cable detect
#define _76PIN_PIN_16                           (0 & 0x0F) // Page 10-0x03[2:0]
...
// AUX_CHP_1
#define _76PIN_PIN_33                           (8 & 0x0F)//(3 & 0x0F) // Page 10-0x0A[2:0]
// 0 ~ 8 (0: P3D2i<I>, 1: Reserved, 2: P3D2o<OD>, 3: AUXp1, 8:DDCSCL1)

// AUX_CHN_1
#define _76PIN_PIN_34                           (8 & 0x0F)//(3 & 0x0F) // Page 10-0x0B[2:0]
...
// IR IN
#define _76PIN_PIN_66                           (0 & 0x0F) // Page 10-0x2A[2:0]
// 0 ~ 6 (0: P7D2i<I>, 1: P7D2o<PP>, 2: P7D2o<OD>, 3: PWM2<PP>, 4: PWM2<OD>,
//        5: TCON[1],  6: IRDA_in )

// ADJBACKLITE 
#define _76PIN_PIN_68                           (3 & 0x0F) // Page 10-0x30[2:0]
...
// vcc off en
#define _76PIN_PIN_73                           (2 & 0x0F) // Page 10-0x36[2:0]
