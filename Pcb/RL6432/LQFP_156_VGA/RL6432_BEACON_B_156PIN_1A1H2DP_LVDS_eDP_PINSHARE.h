...
#if(_USER_PCB_BOARD_TYPE == _BX_CL1901_PCB_BOARD)
// BACKLIGHT_12V_ONOFF
...
#if((_USER_PCB_BOARD_TYPE == _MR_CL13XX_PCB_BOARD) || (_USER_PCB_BOARD_TYPE == _JN_CL15XX_PCB_BOARD))
// BackLight En(Beacon) 
...
#elif(_KL_5V_12V_GPIO_CONTROL == _ON)
// KL board +5V control
